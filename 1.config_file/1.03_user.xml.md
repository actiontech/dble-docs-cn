...
<td  ><p>可选项，默认不限制，值为IP，多个用逗号隔开</p></td>
<td  ><p>一旦配置，默认允许本机登陆</p></td>
</tr>
<tr>
<td  ><p>readOnly</p></td>
<td  ><p>是否是只读管理用户</p></td>
...
user.privileges 下的shema的dml权限，可配置多值
...
本版本暂不可用，登陆会提示 "this version does not support rwSplitUser"
...
<td  ><p>租户名</p></td>
<td  ><p>可选配置。和用户名相当于整个用户列表的联合主键</p></td>
<td  ><p>某些场景，比如JDBC可使用onnectionAttributes来指定租户<br/>
例如：jdbc:mysql://127.0.0.1:8066?connectionAttributes=tenant:tenant1</p></td>
</tr>
<tr>
<td  ><p>dbGroup</p></td>
...
<dble:user xmlns:dble="http://dble.cloud/">
    ...
    <shardingUser name="root2" password="123456" schemas="testdb2" maxCon="20" tenant="tenant1">
