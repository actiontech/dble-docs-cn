...
<td><sub>是否开启检查项，检查delete语句不包含where条件</sub></td>
<td><sub>false</sub></td>
<td><p><sub>true - 启用</sub></p><p><sub>false -不启用</sub></p></td>
<td><p><sub>启用后，如果发现delete语句没有限定条件会抛出异常，举例：delete from suntest;</sub></p></td>
<td><sub>可用</sub></td>
</tr>
<tr>
...
<td><sub>是否开启检查项，检查update语句不包含where条件</sub></td>
<td><sub>false</sub></td>
<td><p><sub>true - 启用</sub></p><p><sub>false -不启用</sub></p></td>
<td><p><sub>启用后，如果发现update语句没有限定条件会抛出异常。举例：update suntest set name = '33';</sub></p></td>
<td><sub><span>可用</span></sub></td>
</tr>
<tr>
...
<td><sub>true</sub></td>
<td><p><sub>true - 进行</sub></p><p><sub>false -不进行</sub></p></td>
<td><p><sub>如果进行校验，则不允许INTERSECT语句，</sub></p>
<p><sub>当且仅当left sql的from不是空并且right from为空的时候不能通过校验</sub></p>
