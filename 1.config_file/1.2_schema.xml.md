...
<td class="tg-yw4l">dataNode对应的存在于mysql物理实例中的schema,可以配置单个或多个使用,&#36;-分割,例如"db$0-743"代表db0,db1...db743</td>
<td class="tg-yw4l">否</td>
<td class="tg-yw4l">所使用的详细数据库节点</td>
</tr>
<tr>
<td class="tg-yw4l">dataHost</td>
<td class="tg-yw4l">dataNode对应的数据库实例,可以配置单个或多个使用,&#36;-分割,例如"dh$0-7"代表dh0,dh1...dh7</td>
<td class="tg-yw4l">否</td>
