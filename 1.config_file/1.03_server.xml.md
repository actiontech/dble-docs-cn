...
<td  ><br>
<p><sub>在初始化的时候通过和bufferPoolPageSize的相乘确定缓冲池最后的大小，内存配置建议见<a href="./1.4_wrapper.conf.md">1.4_wrapper.conf</a></sub></p><br></td>
<td  ><br>
<p><sub></sub></p><br></td>
<td  ><br>
<p><sub>实例</sub></p><br></td>
...
<p><sub>
<strong><em>注意：虚拟机参数MaxDirectMemorySize(见<a href="./1.4_wrapper.conf.md">1.4_wrapper.conf</a>)需要大于bufferPoolPageNumber  *  bufferPoolPageSize，否则会触发OOM </em></strong><em>
</em></sub></p><br></td>
<td  ><br>
<p><sub></sub></p><br></td>
<td  ><br>
...
<tr>
<td rowspan="17" style="text-align: center;"  ><sub>系统服务基本参数</sub></td>
<td  ><br>
...
<td  ><br>
<p><sub>大于此连接数之后,建立连接会失败.注意当各个用户的maxcon总和值大于此值时，以当前值为准</sub>
...
<tr>
<td  ><br>
<p><sub>useOldMetaInit</sub></p><br></td>
<td  ><br>
<p><sub>是否启用旧的meta数据加载方式</sub></p><br></td>
<td  ><br>
<p><sub>默认0，不启用</sub></p><br></td>
<td  ><br>
<p><sub>是否使用旧的meta数据加载方式，旧的方式性能较差，但使用了较长时间，比较稳定</sub></p>
<br></td>
<td  ><br>
<p><sub>1 是 0否</sub></p><br></td>
<td  ><br>
<p><sub>全局</sub></p><br></td>
<td  ><br><p><sub>2.18.10.0引入</sub></p><br></td>
</tr>
<tr>
...
<td   rowspan="2"> <p><sub><font size="1">host是多个平行配置的唯一标识,host重复配置会导致部分配置丢失，如单个IP配多个用户请在user属性里用逗号隔开。</font></sub></p>
