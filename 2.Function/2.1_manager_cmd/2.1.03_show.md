...
mysql> show @@datanode;
+------+----------------+--------+------+------+---------+---------------+
| NAME | DATHOST        | ACTIVE | IDLE | SIZE | EXECUTE | RECOVERY_TIME |
+------+----------------+--------+------+------+---------+---------------+
| dn1  | dh1/dble_test  |      0 |    0 | 1000 |      34 |            -1 |
| dn2  | dh2/dble_test  |      0 |    0 | 1000 |      34 |            -1 |
| dn3  | dh1/dble2_test |      0 |    0 | 1000 |      26 |            -1 |
| dn4  | dh2/dble2_test |      0 |    0 | 1000 |      26 |            -1 |
| dn5  | dh1/nosharding |      0 |    0 | 1000 |       9 |            -1 |
+------+----------------+--------+------+------+---------+---------------+
...
描述：此功能在2.20.04.0 版本已经废除。展示当前cluser信息  
